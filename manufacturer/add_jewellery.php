...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $manufacturer_id = $user_id; // Set to the logged-in manufacturer
...
POST['real_blockchain_hash']) ? $conn->real_escape_string(<?php
$base_url = "/GitHub/Hybrid block chain project";
require_once '../includes/db_connect.php';
require_once '../includes/logger.php';
session_start();
...
<?php require_once '../includes/footer.php'; ?>
POST['real_blockchain_hash']) : "0x" . hash('sha256', $name . time());
